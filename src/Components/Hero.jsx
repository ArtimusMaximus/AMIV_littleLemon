    ...
    return (
        <>
            <div className='row-start-1 xl:col-start-2 col-start-1 sm:col-start-2 col-end-5 col-span-3 sm:pb-5 mx-auto'>
                ...
                <span className=''>
                    <img className='sm:w-10 md:w-12 lg:w-16 sm:mt-1 md:mt-3 lg:mt-4 rounded-2xl sm:opacity-100 hover:duration-200 hover:scale-125' src={logo5} alt="Main lemon logo" />
                    </span>n
                </p>
            ...
            <div className='col-start-4 col-end-5 row-start-1 my-auto mx-auto hidden xl:block'><img className='w-48' src={organicSeal} alt="USDA organic official seal" /></div>
        </>
    )
}
        ...
        <>
            <div className="text-yellow-100 p-1 sm:p-4 mx-auto grid grid-cols-4 grid-rows-1">
                <div className="col-span-full row-start-1 sm:col-span-1 mx-auto">
                    <img className='w-46 sm:w-64 rounded-2xl sm:opacity-100 mt-5 sm:mt-0 hover:duration-200 hover:scale-125' src={logo5} alt="Main lemon logo" />
                </div>
            <Title />
            </div>
        </>
