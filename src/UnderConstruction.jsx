    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-3 w-full h-screen bg-gradient-to-br from-yellow-300 via-pink-300 to-lime-300 ">
                ...
                <img className="w-36 md:w-72 p-2 row-start-3 mr-auto md:mx-auto md:my-auto rounded-full col-start-1 col-end-2" src={image1} alt="" />
                <img className="w-36 md:w-72 p-2 row-start-3 col-start-1 md:col-start-3 md:row-start-1 md:row-end-2 ml-auto md:my-auto md:mx-auto rounded-full md:row-span-2 " src={image2} alt="" />
